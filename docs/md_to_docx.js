// Convert LPM_SIM_Documentation.md to .docx using docx-js.
...
const inputPath  = path.join(__dirname, 'LPM_SIM_Documentation.md');
const outputPath = path.join(__dirname, 'LPM_SIM_Documentation.docx');
